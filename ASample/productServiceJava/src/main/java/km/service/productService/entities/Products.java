...
public class Products implements Serializable {
    ...
    public Products(Integer productID, String sku, String productName, String productDescription, Integer supplierID, Integer categoryID, Integer quantityPerUnit, String unitSize, Double unitPrice, Double msrp, Double unitWeight, Integer unitsInStock, String picture) {
        super();
        this.productID = productID;
        this.sku = sku;
        this.productName = productName;
    ...
    // Getters and setters for each field, along with the @JsonProperty annotations

    // Additional methods for handling any other JSON properties, using the @JsonAnyGetter and @JsonAnySetter annotations
